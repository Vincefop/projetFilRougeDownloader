...
class FindContours {
    ...
    public FindContours(String[] args) throws Exception {
        ...
        //String filename="C:\\Users\\Administrateur\\Desktop\\Formation_java\\projet fil rouge\\photos\\photos benoit\\1 ok.jpg";

        Mat src = Imgcodecs.imread(filename);
        System.out.println("filename : yy"+filename+"yy");
        if (src.empty()) {
